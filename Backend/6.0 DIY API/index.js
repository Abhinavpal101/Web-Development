...
const joke_count = Math.floor(Math.random()*jokes.length);
res.json(jokes[joke_count]);
console.log(jokes[joke_count]);
});
...
app.patch("/jokes/:id", (req, res) => {
  ...
  jokes[searchedIndex] = replacedJoke;
