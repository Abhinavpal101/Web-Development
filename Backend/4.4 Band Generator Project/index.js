...
app.post("/submit", (req, res) => {
  ...
  // // console.log(totalAdj, totalNoun);
  // const randomAdj = adj[Math.floor(Math.random() * totalAdj)];
  // const randomNoun = noun[Math.floor(Math.random()*totalNoun)];

  // res.render("index.ejs", {adjName : randomAdj, nounName : randomNoun,});
  // console.log(randomConst, randomNoun);
